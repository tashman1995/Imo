...
import { closeShowPostModal, openShowPostModal } from "../../../actions/post";
      ...
      <Modal
        ...
        <div className="show-modal">
          <div className="show-modal__image-container">
            {post && <img src={post.image[0]} className="show-modal__image" />}
            <img
              src="http://res.cloudinary.com/doyhcbl8x/image/upload/v1605022691/j2esxp0icqfyxnv6hrky.jpg"
          ...
          <Measure
            ...
            onResize={(contentRect) => {
              contentRect.entry &&
                setViewport({ ...viewport, width: contentRect.entry.width });
            ...
            {({ measureRef }) => (
              <Scrollbars
                ...
                <div className="show-modal__info " ref={measureRef}>
                  <div className="show-modal__header">
                    <div className="show-modal__header--left">
                      <h1 className="heading-primary u-margin-bottom-smallest">
                        {post && post.title} Top of Pen y Fan
                      </h1>
                  ...
                  <div className="show-modal__description description">
                    ...
                    <div className="description__content u-margin-bottom-small">
                      <p className="paragraph">
                        Alt text tells people what is in an image, such as text
                        or basic essential details. If an image fails to load,
                        alt text will display in its place. Search engines also
                        index alt text information and consider it a factor when
                        determining search engine ratings.
                      </p>
                    </div>
                  </div>
                  <div className="show-modal__specific-info specific-info">
                    <div className="specific-info__item">
                      ...
                      <p className="paragraph">Sunrise</p>
                    </div>
                    <div className="specific-info__item">
                  ...
                  <div className="show-modal__map map ">
                    <div className="map__overlay">
                      ...
                      <p className="paragraph">Brecon Beacons, Wales</p>
                    </div>
                    <ReactMapGl
                      {...viewport}
